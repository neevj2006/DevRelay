        ...
        <div className="grid gap-12 p-8 sm:p-12 lg:grid-cols-[1.3fr_0.7fr] lg:p-16">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
              A production-oriented monitoring and incident response platform for
              small engineering teams. DevRelay is currently under active
              development.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-white/10 bg-slate-950/70 p-6">
            <div className="mb-6 flex items-center gap-3">
              ...
              <span className="font-medium text-emerald-300">
                Project foundation operational
              </span>
            </div>
